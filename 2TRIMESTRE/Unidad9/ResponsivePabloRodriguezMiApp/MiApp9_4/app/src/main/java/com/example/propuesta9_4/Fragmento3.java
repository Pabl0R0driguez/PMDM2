...
public class Fragmento3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (miItem != null) {
            ((TextView) rootView.findViewById(R.id.textotitulo)).setText(miItem.titulo);
            ((ImageView) rootView.findViewById(R.id.imagen)).setImageResource(miItem.imagenResId);
            ((TextView) rootView.findViewById(R.id.textocontenido)).setText(miItem.contenido);
