...
public class MainMotocicletas extends AppCompatActivity {
    ...
    private RecyclerView recyclerViewMotocicletas;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerViewMotocicletas = findViewById(R.id.recyclerViewElementos);
        recyclerViewMotocicletas.setLayoutManager(new LinearLayoutManager(this));
        ...
        recyclerViewMotocicletas.setAdapter(adaptador);
    }
}
